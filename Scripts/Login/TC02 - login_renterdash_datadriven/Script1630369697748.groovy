...
WebUI.setText(findTestObject('Object Repository/Login_TestObjects/Page_Poplar Homes/input__email'), email)

WebUI.setText(findTestObject('Object Repository/Login_TestObjects/Page_Poplar Homes/input__password'), password)
